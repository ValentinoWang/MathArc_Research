...
.PHONY: bootstrap bootstrap-full ci-preflight formal-preflight test test-full typecheck architecture workflow-policy quality demo validate serve codex-status acceptance v02-demo v02-validate v02-acceptance v02-workspace-acceptance frankl-replay ci ci-full clean-ci baseline smoke-claude
...
v02-workspace-acceptance:
	$(PYTHON) scripts/v0_2_workspace_acceptance.py
...
ci: ci-preflight quality test validate v02-validate codex-status acceptance v02-acceptance v02-workspace-acceptance frankl-replay
...
ci-full: formal-preflight quality test-full validate v02-validate codex-status acceptance v02-acceptance v02-workspace-acceptance frankl-replay
