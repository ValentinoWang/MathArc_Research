...
| --- | --- | --- | --- | --- | --- | --- | --- |
| AC-01 | behavior | none | machine/unit | 在 matharc/v02/state_machine.py 中实现停止、排空、暂停和取消状态协议 | Unit | Automatic | Yes |
| AC-02 | behavior | none | machine/integration-contract | 在 tests/test_runtime_lifecycle_control.py 中证明停止后不再接收新任务且活动任务有明确终止结果 | Integration | Automatic | Yes |
