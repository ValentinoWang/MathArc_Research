...
| --- | --- | --- | --- | --- | --- | --- | --- |
| AC-01 | behavior | none | machine/e2e | 在 tests/test_runtime_adversarial_drills.py 中执行崩溃、篡改、虚假反例、重复导入和权限演练 | E2E | Automatic | Yes |
| AC-02 | behavior | none | machine/non-functional | 在 tests/test_runtime_attack_recovery.py 中证明每条攻击路径都被拒绝或安全恢复 | Non-functional | Automatic | Yes |
...
| AC-02 | Non-functional | tests/test_runtime_attack_recovery.py | Automatic | Yes |
