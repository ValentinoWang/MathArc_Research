...
- Acceptance owner: 试点部署负责人
- Approval evidence: TBD
- Request source: SRC-MATHARC-RUNTIME-CONTRACT-HTML#html:li[23]
- SSOT node: OPS1
...
Item OPS1 is owned by 试点部署负责人; access to the interface declared for OPS1 and pilot-operations follows the acceptance seeds below and no wider grant.
