...
- Request source: SRC-MATHARC-RUNTIME-CONTRACT-HTML#html:requirement-id=SRC-SYN3
- SSOT node: SYN3
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| AC-01 | behavior | SRC-SYN3 | machine/unit | 在 matharc/v02/runtime/episode_memory.py 中从真实运行蒸馏 FailureMemory 与 EpisodeMemory 记录 | Unit | Automatic | Yes |
...
| --- | --- | --- | --- | --- |
| AC-01 | Unit | matharc/v02/runtime/episode_memory.py | Automatic | Yes |
