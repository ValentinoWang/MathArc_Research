...
- Request source: SRC-MATHARC-RUNTIME-CONTRACT-HTML#html:h2[5]
- SSOT node: DUR4
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| AC-01 | behavior | SRC-DUR4 | machine/local-runtime | 在 matharc/v02/recovery.py 中从确定的 GenerationCommit 边界生成恢复计划和故障矩阵 | Local runtime | Automatic | Yes |
