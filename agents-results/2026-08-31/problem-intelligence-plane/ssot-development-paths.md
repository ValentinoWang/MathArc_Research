...
当前计划状态是“治理已对账、决定版本 2 已接受、L1/L2/A2/S1/S2/A3/T1/T2/A4/R1 已接受，Q1 已解锁”。它是一份开发计划和编排 SSOT，不是功能完成报告。
...
| Q1 | P4 | 1/1/1/1/2 | READY | 0 | 研究负责人 | EG-PLAN | R1 已接受 | source:ready | A5 |
...
并行宽度的逻辑目标由独立交付物决定；当前正式前沿只有 Q1。后续实现必须等待上游验收节点，不因已接受决定而越过依赖。
...
D1 与 D2 已接受，`decision.problem-intelligence.amendment@2` 已解锁其正式消费者；S1、S2、A3、T1、T2、A4 和 R1 已接受，当前前沿是 Q1。
...
当前正式前沿是 Q1：D1、D2、A1、L1、L2、A2、S1、S2、A3、T1、T2、A4、R1 已接受；A5 仍因 Q1 的硬依赖而阻塞。R1 已独立验收固定三例上的四路检索记录、消融、身份防篡改和保守小样本边界。计划仍需在各后续节点完成各自的专项证据，不能把本状态标记为部署完成或数学结论。
